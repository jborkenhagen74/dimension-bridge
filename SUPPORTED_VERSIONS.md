...
|---|---:|---|---|
| 1.20.1–1.20.4 | 17 | `legacy` – Identifier + PacketByteBuf | `dimensionbridge-fabric-<MC>-1.2.0+mc<MC>.jar` |
| 1.20.5–1.21.10 | 21 | `typed` – CustomPacketPayload + ResourceLocation | `dimensionbridge-fabric-<MC>-1.2.0+mc<MC>.jar` |
| 1.21.11 | 21 | `typed-identifier` – CustomPacketPayload + Identifier | `dimensionbridge-fabric-<MC>-1.2.0+mc<MC>.jar` |
| 26.1–26.2 | 25 | `unobfuscated` – nicht remappendes Loom | `dimensionbridge-fabric-<MC>-1.2.0+mc<MC>.jar` |
